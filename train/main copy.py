...
parser.add_argument('--outdir', type=str, default='/ssd0/checkpoints/fast-llm/no_l1loss')
parser.add_argument('--cpdir', type=str, default='/ssd0/checkpoints/fast-llm/no_l1loss')
